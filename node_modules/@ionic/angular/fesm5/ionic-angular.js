...
import { HostListener, ElementRef, Directive, Inject, NgZone, defineInjectable, inject, Injectable, Optional, ChangeDetectorRef, Component, ChangeDetectionStrategy, InjectionToken, ApplicationRef, Injector, EventEmitter, ViewContainerRef, ComponentFactoryResolver, Attribute, SkipSelf, Output, ViewChild, ContentChild, TemplateRef, IterableDiffers, APP_INITIALIZER, NgModule } from '@angular/core';
...
var Platform = /** @class */ (function () {
    ...
    Platform.ngInjectableDef = defineInjectable({ factory: function Platform_Factory() { return new Platform(inject(DOCUMENT), inject(NgZone)); }, token: Platform, providedIn: "root" });
    Platform = __decorate([
        Injectable({
            providedIn: 'root',
        }),
...
var NavController = /** @class */ (function () {
    ...
    NavController.ngInjectableDef = defineInjectable({ factory: function NavController_Factory() { return new NavController(inject(Platform), inject(Location), inject(UrlSerializer), inject(Router, 8)); }, token: NavController, providedIn: "root" });
...
var ActionSheetController = /** @class */ (function (_super) {
    ...
    ActionSheetController.ngInjectableDef = defineInjectable({ factory: function ActionSheetController_Factory() { return new ActionSheetController(); }, token: ActionSheetController, providedIn: "root" });
...
var AlertController = /** @class */ (function (_super) {
    ...
    AlertController.ngInjectableDef = defineInjectable({ factory: function AlertController_Factory() { return new AlertController(); }, token: AlertController, providedIn: "root" });
...
var LoadingController = /** @class */ (function (_super) {
    ...
    LoadingController.ngInjectableDef = defineInjectable({ factory: function LoadingController_Factory() { return new LoadingController(); }, token: LoadingController, providedIn: "root" });
...
var MenuController = /** @class */ (function () {
    ...
    MenuController.ngInjectableDef = defineInjectable({ factory: function MenuController_Factory() { return new MenuController(); }, token: MenuController, providedIn: "root" });
...
var PickerController = /** @class */ (function (_super) {
    ...
    PickerController.ngInjectableDef = defineInjectable({ factory: function PickerController_Factory() { return new PickerController(); }, token: PickerController, providedIn: "root" });
...
var ToastController = /** @class */ (function (_super) {
    ...
    ToastController.ngInjectableDef = defineInjectable({ factory: function ToastController_Factory() { return new ToastController(); }, token: ToastController, providedIn: "root" });
...
var DomController = /** @class */ (function () {
    ...
    DomController.ngInjectableDef = defineInjectable({ factory: function DomController_Factory() { return new DomController(); }, token: DomController, providedIn: "root" });
...
var AnimationController = /** @class */ (function () {
    ...
    AnimationController.ngInjectableDef = defineInjectable({ factory: function AnimationController_Factory() { return new AnimationController(); }, token: AnimationController, providedIn: "root" });
...
var GestureController = /** @class */ (function () {
    ...
    GestureController.ngInjectableDef = defineInjectable({ factory: function GestureController_Factory() { return new GestureController(); }, token: GestureController, providedIn: "root" });
