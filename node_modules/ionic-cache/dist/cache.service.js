...
var isJsOrResponseType = function (data) {
...
var CacheService = /** @class */ (function () {
    ...
    CacheService.prototype.saveBlobItem = function (key, blob, groupKey, ttl) {
        ...
        if (ttl === void 0) { ttl = this.ttl; }
        return __awaiter(this, void 0, void 0, function () {
            var expires, type, base64data, value, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.cacheEnabled) {
                        ...
                        expires = new Date().getTime() + ttl * 1000, type = blob.type;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.asBase64(blob)];
                    case 2:
                        base64data = _a.sent();
                        value = JSON.stringify(base64data);
                        return [2 /*return*/, this._storage.set(key, {
                                value: value,
                                expires: expires,
                                type: type,
                                groupKey: groupKey
    ...
    CacheService.prototype.asBase64 = function (blob) {
    ...
    CacheService.prototype.loadFromDelayedObservable = function (key, observable, groupKey, ttl, delayType, metaKey) {
        ...
        this.getItem(key)
            ...
            _this.getRawItem(key)
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CacheService.decodeRawData(res)];
                        case 1:
                            result = _a.sent();
                            if (metaKey) {
